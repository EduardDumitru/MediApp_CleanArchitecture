...
namespace Application.CommandsAndQueries
{
    public class AddEmployeeCommandValidator : AbstractValidator<AddEmployeeCommand>
    {
        ...
        private bool BeHigherThanStartHourByAtLeastFourHours(AddEmployeeCommand addEmployeeCommand, TimeSpan endHour)
        {
        ...
        private bool HaveNoMedicalCheckTypeIfNotDoctor(AddEmployeeCommand employeeCommand, short employeeTypeId)
        {
            var doctorTypeId = GetDoctorTypeId();
            return employeeTypeId == doctorTypeId || !employeeCommand.MedicalCheckTypeId.HasValue;
        }

        private bool HaveMedicalCheckTypeIfDoctor(AddEmployeeCommand employeeCommand, short employeeTypeId)
        {
            var doctorTypeId = GetDoctorTypeId();
            return employeeTypeId != doctorTypeId || employeeCommand.MedicalCheckTypeId.HasValue;
        }
